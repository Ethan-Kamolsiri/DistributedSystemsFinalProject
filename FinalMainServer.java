...
public class MainServer {
    ...
    // rerouteCustomers now blocks until an FR exists, then dispatches all orphans there
    static void reRouteCustomers(FRControl deadFR) {
        ...
        for (Integer customerID : orphans) {
            ...
            owner.sendMessage("Customer: " + customerID + " is being rerouted (their fitting room crashed)");
        }
    ...
    static class FRControl implements Runnable {
        ...
        //Tracks customers inside the fitting Room
            ...
            try {
                ...
                while ((line = in.readLine()) != null) {
                    ...
                    if (action != null) {
                        ...
                        //removes customer when done with cycle
                ...
                //this will make sure any customers left in the fittingroom are rerouted and finish the cycle
        ...
        String classify(String line) {
            ...
            if (line.contains("Server IP")) return line;
            if (line.contains("entered")) return "ENTERED ON SERVER" + socket.getRemoteSocketAddress();
